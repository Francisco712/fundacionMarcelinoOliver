...
angular.module('myApp.colabora', ['ngRoute', 'ngMaterial'])

.config(['$routeProvider', function($routeProvider) {
  $routeProvider.when('/colabora/:page', {
    templateUrl: 'colabora/colabora.html',
    controller: 'ColaboraCtrl'
  });
}])

.controller('ColaboraCtrl', function($scope, $http, $filter, $log, $location, $routeParams, config, notices) {
