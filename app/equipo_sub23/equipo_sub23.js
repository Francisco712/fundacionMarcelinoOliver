...
angular.module('myApp.equipo23', ['ngRoute', 'ngMaterial'])

.config(['$routeProvider', function($routeProvider) {
  $routeProvider.when('/elite-sub23/:page/:subPage', {
    templateUrl: 'equipo_sub23/equipo_sub23.html',
    controller: 'Equipo23Ctrl'
  });
}])

.controller('Equipo23Ctrl', function($scope, $http, $filter, $log, $location, $routeParams, config, notices) {
