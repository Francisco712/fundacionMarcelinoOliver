...
angular.module('myApp.equipoFemenino', ['ngRoute', 'ngMaterial'])

.config(['$routeProvider', function($routeProvider) {
  $routeProvider.when('/ciclismo-femenino/:page/:subPage', {
    templateUrl: 'equipo_femenino/equipo_femenino.html',
    controller: 'equipoFemeninoCtrl'
  });
}])

.controller('equipoFemeninoCtrl', function($scope, $http, $filter, $log, $location, $routeParams, config, notices) {
