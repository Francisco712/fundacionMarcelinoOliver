...
angular.module('myApp.equipoBase', ['ngRoute', 'ngMaterial'])

.config(['$routeProvider', function($routeProvider) {
  $routeProvider.when('/ciclismo-base/:page/:subPage', {
    templateUrl: 'equipo_base/equipo_base.html',
    controller: 'EquipobaseCtrl'
  });
}])

.controller('EquipobaseCtrl', function($scope, $http, $filter, $log, $location, $routeParams, config, notices) {
