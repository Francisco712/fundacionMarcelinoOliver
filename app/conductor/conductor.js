...
angular.module('myApp.conductor', ['ngRoute', 'ngMaterial'])

.config(['$routeProvider', function($routeProvider) {
  $routeProvider.when('/conductor/:page/:subPage', {
    templateUrl: 'conductor/conductor.html',
    controller: 'ConductorCtrl'
  });
}])

.controller('ConductorCtrl', function($scope, $http, $filter, $log, $location, $routeParams, config, notices) {
